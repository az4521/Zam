...
<Portal>
    ...
    >
        <div
            ...
            class="flex max-h-[min(620px,90dvh)] w-full max-w-md flex-col overflow-hidden rounded-lg border border-discord-divider bg-discord-backgroundSecondary shadow-2xl"
        >
            <div
            ...
            <div class="min-h-0 flex-1 overflow-y-auto px-2 pb-2">
                ...
                {:else}
                    <p
                        class="px-3 py-8 text-center text-sm text-discord-textMuted"
                    >
            ...
            <div
                class="flex justify-end gap-2 border-t border-discord-divider p-3"
            >
                <button
                    type="button"
                    onclick={closeModal}
