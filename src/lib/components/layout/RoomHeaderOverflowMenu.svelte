<script lang="ts">
    ...
    const ICONS: Record<RoomHeaderMenuKey, string> = {
        ...
        // Mirrors lucide's `Users` (the desktop member-list button) as a solid
        // glyph. Two people, not one-person-plus: this row *opens* the member
        // list, it does not invite anyone.
        members:
