...
<div class="space-y-6">
                    ...
                    >
                        ...
                        <div class="flex items-center gap-2 flex-shrink-0">
                            <button
                                type="button"
                                disabled
                                title="Plugin settings (coming soon)"
                                class="p-1.5 rounded text-discord-textMuted hover:text-discord-textPrimary hover:bg-discord-messageHover transition-colors disabled:opacity-50 disabled:hover:bg-transparent"
                            >
                                <Settings size={16} />
                            </button>
                            <ToggleSwitch
                                ...
                                label="Enable {p.name}"
                                title={busy[p.id] ? "Working..." : undefined}
                            />
                            {#if p.source === "repo"}
                                <button
                                    type="button"
            ...
            {#each repoList as repo (repo.ref)}
                <div>
                    ...
                    {#if browse[repo.ref]?.loading}
                        <p class="text-xs text-discord-textMuted">Loading...</p>
    ...
    <section>
        ...
        <div class="p-3 rounded bg-discord-backgroundTertiary space-y-3">
            ...
            <p class="text-xs text-discord-textMuted">
                Third-party repos run full-trust code with full access to your
                account and messages. Only add repos you trust.
            </p>
        ...
        <div class="space-y-3">
            ...
            >
                <div class="flex-1 min-w-0">
                    ...
                    <p class="text-xs text-discord-textMuted">Coming soon.</p>
                </div>
                <ToggleSwitch
                    checked={false}
                    onChange={() => {}}
